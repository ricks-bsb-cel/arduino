...
U8G2_SSD1306_128X64_NONAME_F_SW_I2C u8g2(U8G2_R0, D6, D7, U8X8_PIN_NONE);  // Com display externo conectado em SCL>D6/D7<SDA
/*
...
public:
  ...
  void ShowBigValue(String title, String value, int valueCol = 1) {
    if (this->lcdEnabled) {
      u8g2.clearBuffer();
      u8g2.drawFrame(1, 0, 127, 16);
      ...
      u8g2.drawStr(5, 30, title.c_str());

      u8g2.setFont(u8g2_font_helvB24_te);
      u8g2.drawStr(valueCol, 60, value.c_str());
